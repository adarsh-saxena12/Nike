...
const Footer = () => {
  return (
    <footer className="max-container">
         <div className="flex justify-between items-start gap-20 flex-warp max-lg:flex-col">
          <div className="flex flex-col items-start">
           ...
           <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti impedit nemo, minus tempore nostrum facilis reprehenderit!
           </p>
         ...
         <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap mt-20">
            {
